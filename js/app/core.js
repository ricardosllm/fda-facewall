      ...
      dynamodb.query(params, function(err, data) {
        ...
        else
        {
          ...
          data.forEach(function(item){
            ...
            ul.prepend(jQuery(
              '<article class="entry box-item imgSnap ">' +
                '<div class="box-wrap"><figure class="entry-thumb zoomable">' +
                '<a class="fancybox grow" href="' +
                item.rawurl.S +
                '"><img class="facethumbnail" src="' +
                item.croppedurl.S +
                '" alt=""></a></figure><div class="entry-meta">' +
                '<span class="love-no imgmeta">' + 'Camera ' +
                item.cameraid.S +
                '</span><span style="padding-left:30px;" class="love-no imgmeta">' +
                timeConverter(item.unixtimestamp.N) +
